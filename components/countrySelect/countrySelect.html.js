// Elements
import { Label, Select, Option } from "../../template/elements.html.js";

/**
 * Creates a country select dropdown component.
 *
 * @param {Object} params - The parameters for the country select dropdown.
 * @param {string} [params.label="Country"] - The label for the select dropdown.
 * @param {string} [params.name="country"] - The name attribute for the select dropdown.
 * @returns {Object} The country select dropdown component configuration.
 */
